...
class EmbedderNode(Node):
    ...
    Payload data from an Tmage from an sensor_msgs/msg/Image or bob_msgs/msg/STTImage. 
    ...
    {"collection":"stories", "documents":["some story text","text about something strange"], "metadatas": [{"title":"The end"}, {"title":"Dark star"}], "ids":['id1','id2']}
    """
